...
#Local imports
from TDEED.model.modules import BaseRGBModel, EDSGPMIXERLayers, FCLayers, FC2Layers, CrossAttentionLayer, CoordEncoding, step, process_prediction, process_double_head, process_labels
from TDEED.model.shift import make_temporal_shift
...
class TDEEDModel(BaseRGBModel):
    ...
    class Impl(nn.Module):
        ...
        def forward(self, x_c, x_f, pos, y = None, inference=False, augment_inference=False):
            ...
            assert batch_size_c == batch_size_f, f'Batch size of local and global views must be the same but got {batch_size_c} and {batch_size_f}'
